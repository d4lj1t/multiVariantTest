...
$(function () {
    ...
    $('.sticky-summary-wrapper').append('<div id="timer"><div class="inner"><span class="section1">Flash Sale Ends in: <span id="mobclock"></span></span></div><div style="clear: both;"></div></div>');
