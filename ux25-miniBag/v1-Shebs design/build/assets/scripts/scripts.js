...
HOFMaxymiser.UX25 = function() {
    ...
    Model.insertMessageRules = [{
        text: "Order by Midnight for free Buy & Collect tomorrow <span class='font-xs clearfix'></span>",
        time: 18
    }];
    ...
    View.injectMessage = function() {
        ...
        strVar += "  <h3>Hello Again<\/h3>";
        strVar += "  <p>We’ve saved the items you liked on your last visit<\/p>";
